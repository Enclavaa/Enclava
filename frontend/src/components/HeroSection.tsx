  ...
  return (
    <section className="min-h-screen bg-black text-white flex flex-col justify-center px-6 md:px-12 lg:px-24">
      <div className="max-w-6xl mx-auto w-full">
        {/* ASCII Art Header */}
        <div className="font-mono text-xs md:text-sm text-violet-500 mb-8">
...
╚══════╝╚═╝  ╚═══╝ ╚═════╝╚══════╝╚═╝  ╚═╝  ╚═══╝  ╚═╝  ╚═╝`}
        ...
        <h1 className="text-4xl md:text-7xl lg:text-8xl font-black uppercase leading-none mb-6">
          Own Your Data.
          <br />
          <span className="text-violet-500">Share It Safely.</span>
        </h1>

        <div className="border-l-4 border-violet-500 pl-6 mb-12 max-w-2xl">
        ...
        {/* CTA Button */}
        {/* <div>
          <button className="bg-violet-500 text-black font-black text-xl md:text-2xl px-12 py-6 uppercase tracking-wider hover:bg-white transition-colors duration-200 border-4 border-violet-500">
            Join the Waitlist
          </button>
        </div> */}
